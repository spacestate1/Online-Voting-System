...
<tbody>
    ...
    <tr style='color:black ; font-size: 15px; font-family:Times'>
        ...
        <td>
            <button class='btn btn-success btn-sm edit btn-curve' style='background-color: #9CD095 ;color:black ; font-size: 12px; font-family:Times' data-id='<?php echo $row['id']; ?>'><i class='fa fa-edit'></i> Edit</button>
            <button class='btn btn-danger btn-sm delete btn-curve' style='background-color:#ff8e88 ;color:black ; font-size: 12px; font-family:Times' data-id='<?php echo $row['id']; ?>'><i class='fa fa-trash'></i> Delete</button>    
