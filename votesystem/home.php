				    	...
				    	if(pg_num_rows($vquery) > 0){
						    ...
						    <form method="POST" id="ballotForm" action="submit_ballot.php">
				        		...
				        		<div class="text-center">
					    			<button type="button" class="btn btn-curve btn-primary btn-lg" style="background-color: #4682B4 ;color:black ; font-size: 22px; font-family:Times" data-toggle="modal" data-target="#preview"><i class="fa fa-file-text"></i> Preview</button>
					    			<button type="submit" class="btn btn-curve btn-success btn-lg" style="background-color:#9CD095 ;color:black ; font-size: 22px; font-family:Times" name="vote"><i class="fa fa-check"></i> Submit</button>
					    		</div>
			    			</form>
				    		<?php
				    	}
